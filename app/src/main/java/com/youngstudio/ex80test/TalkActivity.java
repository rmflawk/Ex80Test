package com.youngstudio.ex80test;
    ...
    void loadDB(){
        ...
        new Thread(){
            ...
            public void run() {
                ...
                String serverUrl="http://rmflawkdk.dothome.co.kr/Android/loadDB.php";
...
//                    });
                    ...
                    for(String row : rows){
                        ...
                        String name= datas[1];
                        String msg= datas[2];
                        String imgPath= "http://rmflawkdk.dothome.co.kr/Android/"+datas[3];
                        String date= datas[4];
